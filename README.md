...
## 标准
1. [IEEE working group](http://grouper.ieee.org/groups/index.html)
2. [IEEE org](https://www.ieee.org/sitemap.html?WT.mc_id=mn_smap)
...
8. [codeproject](https://www.codeproject.com/)
9. [geeksforgeeks](http://www.geeksforgeeks.org/)
...
[let me google it for you](http://www.lmgtfy.com/)

### 博客
1. [the old new thing practical development throughout the evolution of windows](https://blogs.msdn.microsoft.com/oldnewthing/)
...
7. 数学
    ...
    - [数学都知道](http://blog.sciencenet.cn/home.php?mod=space&uid=420554&do=blog&classid=136206&view=me&from=space)
8. 人工智能
...
8. [huqunxing](http://huqunxing.site/tags/C/)
...
5. [网易七鱼](http://qiyukf.com/)
6. [幕布](https://mubu.com/)
### 难以分类
1. 一些博客，比较感兴趣:
    <http://hsfzxjy.github.io/>
...
---
## linux
1.[Linux命令手册大全](http://man.linuxde.net/)


---
## C/C++
1. [cplusplus](http://www.cplusplus.com/)
2. [cppreference](http://en.cppreference.com/)
3. [msdn c++标准库文档zh-cn](https://msdn.microsoft.com/zh-cn/library/hh875057.aspx)
4. [msdn c++标准库文档en-us](https://msdn.microsoft.com/en-us/library/a7tkse1h.aspx)
6. [microsoft doc for visual c++](https://docs.microsoft.com/en-us/cpp/cpp/c-cpp-language-and-standard-libraries)
5. [Bjarne Stroustrup's homepage](http://www.stroustrup.com/)
7. [c++ 标准化](https://isocpp.org/)

## 算法
### 算法博客
1. http://blog.csdn.net/u013761665/article/category/2124077
2. https://61mon.com/
3. http://blog.csdn.net/laojiu_?viewmode=contents
...
5. 数据结构和算法动态可视化工具visualgo：https://visualgo.net/zh
